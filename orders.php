...
<style media="screen">
 ...
 <div class="container" style="margin-top:30px;margin-bottom:30px">
   <center><h3>Your Buying History</h3></center>
   <?php
     $sql = 'SELECT * FROM products where IMEI IN(select fk_imei from buys where fk_cid='.$_SESSION["CID"].')';
     ...
     while($row = $result->fetch_assoc()) {
            ...
            <div class="row prow">
              ...
              <div class="col-3 mt-3">
                 ...
                 <button class="btn btn-primary mb-auto ml-3 mt-3 disabled">Raise Complaint</button>
              </div>
            </div>

            <?php
         }
         echo '<center><img src="congo.jpg" class="mt-3"></center>';
     }
     else{
       echo '<center>';
       echo "<h4 style='color:red'>You Have Nothing Here!!</h4>";
